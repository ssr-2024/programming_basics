...
df = pd.read_csv(f"{lab301_sport}/data.csv", delimiter=';', skiprows=2, na_values='UNKNOWN')

    # Lade den Datensatz und ersetze 'UNKNOWN' durch NaN
    df = pd.read_csv(lab301_sport/data.csv, delimiter=';', skiprows=2, na_values='UNKNOWN')
