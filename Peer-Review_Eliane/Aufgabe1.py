...
input_path = Path('Peer-Review_Eliane/Beispieldaten_Tutorial.xlsx')
output_path = "./Ergebnisdatei.xlsx"
...
for verein, daten in vereinsdaten.items():
    ...
    # Insert the data
    for row, daten_row in enumerate(daten, start=2):
        for col, value in enumerate(daten_row, start=1):
